package webapp.lovelove.member.util;
...
public class GeometryUtil {
    ...
    public static MemberPosition calculate(Double baseLatitude, Double baseLongitude, Double distance, Double bearing) {
        ...
        return new MemberPosition(toDegree(latitude), toDegree(longitude));
    }
